...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 120, 2, 2257);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svg, file, 116, 2, 2189);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, dirty) {
      ...
      ctx2[0].body + "")) html_tag.p(raw_value);
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("counter" in $$props) $$invalidate(3, counter2 = $$new_props.counter);
