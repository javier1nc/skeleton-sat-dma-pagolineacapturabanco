...
import "/Users/javier1nc/Source/SAT/DMA/pagolineabanco/CODIGO/node_modules/@event-calendar/core/index.css";
...
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    p: function update(new_ctx, dirty) {
      ...
      65) setContent_action.update.call(
        null,
        /*$customButtons*/
        ctx[6][
          /*button*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$props2) => {
    if ("buttons" in $$props2) $$invalidate(0, buttons = $$props2.buttons);
    if ("_currentRange" in $$props2) $$invalidate(8, _currentRange = $$props2._currentRange);
    if ("_viewTitle" in $$props2) $$invalidate(9, _viewTitle = $$props2._viewTitle);
    if ("buttonText" in $$props2) $$invalidate(10, buttonText = $$props2.buttonText);
    if ("customButtons" in $$props2) $$invalidate(11, customButtons = $$props2.customButtons);
    if ("date" in $$props2) $$invalidate(12, date = $$props2.date);
    if ("duration" in $$props2) $$invalidate(13, duration = $$props2.duration);
    if ("hiddenDays" in $$props2) $$invalidate(14, hiddenDays = $$props2.hiddenDays);
    if ("theme" in $$props2) $$invalidate(15, theme = $$props2.theme);
    if ("view" in $$props2) $$invalidate(16, view2 = $$props2.view);
    if ("today" in $$props2) $$invalidate(17, today2 = $$props2.today);
    if ("isToday" in $$props2) $$invalidate(1, isToday = $$props2.isToday);
  };
...
function instance2($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$props2) => {
    if ("headerToolbar" in $$props2) $$invalidate(2, headerToolbar = $$props2.headerToolbar);
    if ("theme" in $$props2) $$invalidate(3, theme = $$props2.theme);
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$props2) => {
    if ("datesSet" in $$props2) $$invalidate(1, datesSet = $$props2.datesSet);
    if ("_auxiliary" in $$props2) $$invalidate(2, _auxiliary = $$props2._auxiliary);
    if ("_activeRange" in $$props2) $$invalidate(3, _activeRange = $$props2._activeRange);
    if ("_queue" in $$props2) _queue = $$props2._queue;
    if ("_view" in $$props2) $$invalidate(4, _view = $$props2._view);
...
function instance4($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("plugins" in $$props2) $$invalidate(21, plugins = $$props2.plugins);
    if ("options" in $$props2) $$invalidate(22, options = $$props2.options);
  };
  $$self.$capture_state = () => ({
    setContext,
    beforeUpdate,
  ...
  $$self.$inject_state = ($$props2) => {
    if ("plugins" in $$props2) $$invalidate(21, plugins = $$props2.plugins);
    if ("options" in $$props2) $$invalidate(22, options = $$props2.options);
    if ("state" in $$props2) state = $$props2.state;
    if ("_viewComponent" in $$props2) $$invalidate(6, _viewComponent = $$props2._viewComponent);
    if ("_bodyEl" in $$props2) $$invalidate(7, _bodyEl = $$props2._bodyEl);
    if ("_interaction" in $$props2) $$invalidate(8, _interaction = $$props2._interaction);
    if ("_iClass" in $$props2) $$invalidate(9, _iClass = $$props2._iClass);
    if ("_events" in $$props2) $$invalidate(10, _events = $$props2._events);
    if ("_queue" in $$props2) $$invalidate(11, _queue = $$props2._queue);
    if ("_queue2" in $$props2) $$invalidate(12, _queue2 = $$props2._queue2);
    if ("_tasks" in $$props2) _tasks = $$props2._tasks;
    if ("_scrollable" in $$props2) $$invalidate(13, _scrollable = $$props2._scrollable);
    if ("date" in $$props2) $$invalidate(14, date = $$props2.date);
    if ("duration" in $$props2) $$invalidate(15, duration = $$props2.duration);
    if ("hiddenDays" in $$props2) $$invalidate(16, hiddenDays = $$props2.hiddenDays);
    if ("height" in $$props2) $$invalidate(17, height2 = $$props2.height);
    if ("theme" in $$props2) $$invalidate(18, theme = $$props2.theme);
    if ("view" in $$props2) $$invalidate(19, view2 = $$props2.view);
    if ("prevOptions" in $$props2) $$invalidate(46, prevOptions = $$props2.prevOptions);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
//# sourceMappingURL=chunk-7XG6JH44.js.map
