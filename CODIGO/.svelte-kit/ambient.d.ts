...
declare module '$env/static/private' {
	...
	export const SECRET_DEV_STATE: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_DEV_STATUS: string;
	export const PUBLIC_PATH_BASE: string;
	export const PUBLIC_PATH_APP: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_DEV_STATUS: string;
		PUBLIC_PATH_BASE: string;
		PUBLIC_PATH_APP: string;
