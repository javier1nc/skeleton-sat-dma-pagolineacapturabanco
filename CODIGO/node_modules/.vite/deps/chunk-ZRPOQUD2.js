...
var we = (t, i, e) => i in t ? ye(t, i, { enumerable: true, configurable: true, writable: true, value: e }) : t[i] = e;
var y = (t, i, e) => (we(t, typeof i != "symbol" ? i + "" : i, e), e);
var pe = /\bvoid\s+main\s*\(\s*\)\s*{/g;
function j(t) {
...
function N(t, i) {
  ...
  const r = `_onBeforeCompile${e}`, s = function(o, h) {
    ...
    copy: {
      ...
      configurable: true,
      value: function(o) {
        return t.copy.call(this, o), !t.isShaderMaterial && !t.isDerivedMaterial && (U(this.extensions, o.extensions), U(this.defines, o.defines), U(this.uniforms, UniformsUtils.clone(o.uniforms))), this;
      }
    },
    clone: {
      writable: true,
    ...
    getDepthMaterial: {
      ...
      value: function() {
        ...
        return o || (o = this._depthMaterial = N(
          t.isDerivedMaterial ? t.getDepthMaterial() : new MeshDepthMaterial({ depthPacking: RGBADepthPacking }),
          i
    ...
    getDistanceMaterial: {
      ...
      value: function() {
        ...
        return o || (o = this._distanceMaterial = N(
          t.isDerivedMaterial ? t.getDistanceMaterial() : new MeshDistanceMaterial(),
          i
...
var je = class extends InstancedMesh {
  ...
  setUniformAt(i, e, n) {
    ...
    if (!a) {
      ...
      if (a = r[s] = new InstancedBufferAttribute(new Float32Array(u * this._maxCount), u), l !== null)
        for (let o = 0; o < this._maxCount; o++)
          fe(a, o, l);
      this._instancedUniformNames = [...this._instancedUniformNames, i];
    }
    fe(a, e, n), a.needsUpdate = true;
  }
  /**
...
var qe = () => {
  const t = new BufferGeometry(), i = new Float32Array([
    // top
    0,
    1,
    0,
  ...
  t.setAttribute("position", new BufferAttribute(i, 3));
  ...
  return t.setAttribute("uv", new BufferAttribute(e, 2)), t.computeVertexNormals(), t;
};
var et = new OrthographicCamera(-1, 1, 1, -1, 0, 1);
var tt = class extends BufferGeometry {
  constructor() {
...
` + m.fragmentShader;
    ...
    this.createShaderMaterial = o, this.createRenderTarget = function(c, f, m, p, d, w) {
      ...
      n.xr.enabled = false, n.shadowMap.autoUpdate = false, l.material = c, n.setRenderTarget(f), l.render(n), l.material = a, n.xr.enabled = p, n.shadowMap.autoUpdate = d, n.setRenderTarget(m);
    };
    function h() {
      return `void main()	{
...
var lt = (t, i) => {
  ...
  s.material.uniforms.instructionsTexture = {
    value: a
  }, s.material.uniforms.spritesheetData = { value: null }, s.material.uniforms.fps = { value: 0 }, s.material.uniforms.deltaTime = { value: 0 }, s.material.uniforms.dataSize = { value: new Vector2() }, n.setVariableDependencies(s, [s]);
  const l = n.init();
...
var ut = class {
  constructor() {
    ...
    this._previousTime = 0, this._currentTime = 0, this._startTime = B(), this._delta = 0, this._elapsed = 0, this._timescale = 1, this._useFixedDelta = false, this._fixedDelta = 16.67, this._usePageVisibilityAPI = typeof document < "u" && document.hidden !== void 0, this._usePageVisibilityAPI === true && (this._pageVisibilityHandler = ct.bind(this), document.addEventListener(
      "visibilitychange",
...
var Xt = class extends je {
  constructor(e, n, r, s = {
    ...
    y(this, "_timer");
    y(this, "compute");
    REVISION >= 159 ? (this.instanceMatrix.clearUpdateRanges(), this.instanceMatrix.addUpdateRange(0, n * 16)) : this.instanceMatrix.updateRange.count = n * 16, this.instanceColor && (REVISION >= 159 ? (this.instanceColor.clearUpdateRanges(), this.instanceColor.addUpdateRange(0, n * 3)) : this.instanceColor.updateRange.count = n * 3), this.compute = lt(r, n), this._spriteMaterial = l, s.spritesheet && this.updateSpritesheet(s.spritesheet), this._timer = new ut(), this._animationMap = /* @__PURE__ */ new Map(), this._spriteMaterial.uniforms.animationData.value = this.compute.gpuCompute.getCurrentRenderTarget(
...
var Bt = class extends BufferGeometry {
  ...
  build() {
    const e = new kt(
      ...
      this.settings,
      this.vertices
    ), n = e.positions.length, r = new BufferAttribute(e.index, 1), s = new BufferAttribute(e.positions, 3), a = new BufferAttribute(Ot(n, [0, 0, 1]), 3), l = new BufferAttribute(e.uv, 2);
...
var Kt = class {
  ...
  async build(i = {}) {
    ...
    r = new CanvasTexture(u), r.needsUpdate = true;
    ...
    if (r.matrixAutoUpdate = false, r.generateMipmaps = false, r.premultiplyAlpha = false, r.wrapS = r.wrapT = RepeatWrapping, r.magFilter = r.minFilter = NearestFilter, r.colorSpace = SRGBColorSpace, n.sheetSize = [a, l], i.makeSlimGeometry) {
...
//# sourceMappingURL=chunk-ZRPOQUD2.js.map
